...
public class OrderPrepay_contractreports_ProcessingOption extends TestExecutor {
...
//	List<WebElement> rows = null;
	...
	public String Processtab = ".//a[text()='Process']";
	public String Datestab = ".//a[text()='Dates']";
	public String printmonthofcontract=".//*[@id='PO1T0']";
	public String monthenddate=".//*[@id='PO2T1']";
	public String asofdate=".//*[@id='PO3T1']";
