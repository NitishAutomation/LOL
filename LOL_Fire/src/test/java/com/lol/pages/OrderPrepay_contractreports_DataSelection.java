...
public class OrderPrepay_contractreports_DataSelection extends TestExecutor {
...
//	List<WebElement> rows = null;
	...
	public String businesslineselect = ".//*[@id='LeftOperand1']";
	public String businesslineselectdata = ".//*[@id='RightOperand1']";
	public String agrementstatselect=".//*[@id='LeftOperand2']";
	public String agrementstatselectdata=".//*[@id='RightOperand2']";
