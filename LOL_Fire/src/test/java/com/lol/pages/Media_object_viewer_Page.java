...
public class Media_object_viewer_Page extends TestExecutor {
...
//	List<WebElement> rows = null;
	...
	public String browser_file = ".//*[@id='BUTTONADDIMAGE']";
	public String media_browser_cancel_button=".//*[@id='hc2']";
	public String media_viwer_cancel=".//*[@id='BUTTONCANCEL']";
	
	public String media_attachment_comment=".//*[@id='moreadonly']";
