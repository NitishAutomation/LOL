...
public class Common_BackUp extends TestExecutor {
	...
	public boolean IsObjectsDisplayed(String object) {
		try {
	...
	public boolean IsObjectsDisplayed(String object,String msg) {
		try {
			if (driver.findElement(By.xpath(object)).isDisplayed() == true) {
	...
	public void select_CheckBox(WebElement element, String str) {
	...
	public void select_option_from_toolbar(WebElement element, String str) {
...
*/		}
	...
	public void validateObjectsDisplayedbyid(String id, String msg) {
		try {
