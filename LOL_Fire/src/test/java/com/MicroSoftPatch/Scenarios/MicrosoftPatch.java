...
public class MicrosoftPatch extends WebPage{
	...
	public void recordIsPopulatedOnSearch(String k) throws BiffException, InvalidFormatException, TwfException, IOException, InterruptedException{
		...
		switchToFrame(PageObjectLoader.getPageObject("OTMDairy_SideBar_Frame").getTargetId());
			...
			driver=DriverFactory.getDriver();
		 element = driver.findElement(By.xpath(PageObjectLoader.getPageObject("OTMDairy_OrderManagement_Link").getTargetId()));
		...
		//getElementByUsing("OTMDairy_OrderRelease_Link").click();
		 ...
		 element = driver.findElement(By.xpath(PageObjectLoader.getPageObject("OTMDairy_OrderRelease_Link").getTargetId()));
		 executor = (JavascriptExecutor)driver;
		executor.executeScript("arguments[0].click();", element);
	 ...
	 element = driver.findElement(By.xpath(PageObjectLoader.getPageObject("OTMDairy_OrderReleaseSubLink_Link").getTargetId()));
		 executor = (JavascriptExecutor)driver;
		executor.executeScript("arguments[0].click();", element);
	...
	/*@FSI crystal reporting
	 * @Author-Nitish.Nayak
	 */
	
	public void fsiCrystalReporting(String k) throws TwfException, BiffException, IOException, InterruptedException{
		...
		switchFrameUsingXpath(".//*[@name='content_frame']");
		getElementByUsing("FSICrystalReporting_Folder_Button").click();
		...
		switchToFrame("target_frame");
		switchFrameUsingXpath(".//*[@name='content_frame']");
		getElementByUsing("FSICrystalReporting_Production_Button");
		...
		switchFrameUsingXpath(".//*[@name='content_frame']");*/
		Thread.sleep(7000);
		getElementByUsing("FSICrystalReporting_FSI_Button").click();
		...
		switchToFrame("target_frame");
		switchFrameUsingXpath(".//*[@name='content_frame']");
		waitForElement(getElementByUsing("FSICrystalReporting_RetailIncentiveReport_Link"), 30);
		getElementByUsing("FSICrystalReporting_RetailIncentiveReport_Link").click();
		
		Thread.sleep(3000);
		
		switchToFrame("target_frame");
		switchToFrame("ObjectTabsAndData");
		switchToFrame("ObjectData");
		getElementByUsing("FSICrystalReporting_Priview_Button").click();
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------------------------//
	/*@FSI crystal reporting edge browser
	 * @Author Nitish.Nayak
	 */
	
	public void fsiCrystalReportingEdge(String k) throws TwfException, BiffException, IOException, InterruptedException{
	...
	public void switchFrameUsingXpath(String xpath) throws TwfException{
